...
const CONFIGS: Record<LandingVariant, LandingConfig> = {
  ...
  comunicacao: {
    ...
    subcopy: 'O Editalis varre os diários oficiais todos os dias e entrega na sua caixa só os editais de publicidade, mídia, eventos, conteúdo e marketing — com órgão, prazo e valor. Sem garimpo em PDF, sem deixar concorrência passar.',
    bids: [
    ...
    stepOneDesc: 'Comece por Comunicação — publicidade, mídia, eventos, conteúdo — e refine com palavras-chave, regiões e faixa de valor. Leva dois minutos.',
    ...
    finalH2: 'Nunca mais perca um edital de comunicação.',
