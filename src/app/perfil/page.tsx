...
const emptyPreferences: PreferencesData = { ufs_padrao: [], valor_minimo_interesse: null, abrir_painel_filtrado: false, ocultar_homologadas: false, favoritar_ao_baixar: false, verticals: [], onboarding_completed: false };
